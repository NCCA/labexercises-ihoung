...
TEST(Particle,ctor)
{
  ...
  ASSERT_FLOAT_EQ(p.color.x,0.0f);
  ASSERT_FLOAT_EQ(p.color.y,0.0f);
  ASSERT_FLOAT_EQ(p.color.z,0.0f);
  ASSERT_EQ(p.life,0);
...
TEST(Particle,userCtor)
{
  ...
  ASSERT_FLOAT_EQ(p.dir.z,0.0f);
  ASSERT_FLOAT_EQ(p.color.x,1.0f);
  ASSERT_FLOAT_EQ(p.color.y,1.0f);
  ASSERT_FLOAT_EQ(p.color.z,1.0f);
